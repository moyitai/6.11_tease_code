...
int music_player_play_prev_cycle_single_dev(void)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_PREV_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);///选择上一曲
    if (__this->file == NULL) {
...
int music_player_play_next_cycle_single_dev(void)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_NEXT_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);///选择下一曲
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_first_file(char *logo)
{
    if (logo == NULL) {
        ...
        __this->fsn = dev_manager_scan_disk(__this->dev, NULL, scan_parm, app_var.cycle_mode, (struct __scan_callback *)__this->parm.scan_cb);
    }
    if (__this->fsn == NULL) {
        return MUSIC_PLAYER_ERR_FSCAN;
    }
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_FIRST_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_last_file(char *logo)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_LAST_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_auto_next(void)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_AUTO_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);///选择自动下一曲
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_folder_prev(void)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_PREV_FOLDER_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);///选择播放上一个文件夹
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ...
    fclose(__this->file);
    //播放文件夹第一首
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_NUMBER, folder_info.fileStart, (struct __scan_callback *)__this->parm.scan_cb);
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
#endif
...
int music_player_play_folder_next(void)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_NEXT_FOLDER_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);///选择播放上一个文件夹
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_devcie_prev(struct __breakpoint *bp)
{
    ...
    ///get fscan
    __this->fsn = dev_manager_scan_disk(__this->dev, NULL, (const char *)scan_parm, app_var.cycle_mode, (struct __scan_callback *)__this->parm.scan_cb);
    if (__this->fsn == NULL) {
        return MUSIC_PLAYER_ERR_FSCAN;
    }
    int err = 0;
    if (bp) {
        __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_SCLUST, bp->sclust, (struct __scan_callback *)__this->parm.scan_cb);//根据文件簇号查找断点文件
        if (__this->file == NULL) {
            return MUSIC_PLAYER_ERR_FILE_NOFOUND;
        }
...
int music_player_play_devcie_next(struct __breakpoint *bp)
{
    ...
    if (bp) {
        ...
        __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_FIRST_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);//选择第一个文件播放
        if (__this->file == NULL) {
            return MUSIC_PLAYER_ERR_FILE_NOFOUND;
        }
        err = music_player_decode_start(__this->file, 0);
...
int music_player_play_by_number(char *logo, u32 number)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_NUMBER, number, (struct __scan_callback *)__this->parm.scan_cb);
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_by_sclust(char *logo, u32 sclust)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_SCLUST, sclust, (struct __scan_callback *)__this->parm.scan_cb);//根据簇号查找文件
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_by_path(char *logo, const char *path)
{
    ...
    ///get file
    __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_PATH, (int)path, (struct __scan_callback *)__this->parm.scan_cb);//根据簇号查找文件
    if (__this->file == NULL) {
        return MUSIC_PLAYER_ERR_FILE_NOFOUND;
    }
    ///start decoder
...
int music_player_play_record_folder(char *logo, struct __breakpoint *bp)
{
    ...
    ///需要扫盘
    struct vfscan *fsn = dev_manager_scan_disk(dev, NULL, scan_parm, app_var.cycle_mode, (struct __scan_callback *)__this->parm.scan_cb);
    if (fsn == NULL) {
    ...
    ///get file
    if (bp) {
        __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_BY_SCLUST, bp->sclust, (struct __scan_callback *)__this->parm.scan_cb);
        if (__this->file == NULL) {
            return MUSIC_PLAYER_ERR_FILE_NOFOUND;
        }
        ///start decoder
        ...
        __this->file = file_manager_select(__this->dev, __this->fsn, FSEL_FIRST_FILE, 0, (struct __scan_callback *)__this->parm.scan_cb);//播放录音文件夹第一个文件
        if (__this->file == NULL) {
            return MUSIC_PLAYER_ERR_FILE_NOFOUND;
        }
        ///start decoder

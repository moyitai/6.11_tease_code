...
//UI Layout global objects
static lv_obj_t *tv;                        //TabView widget
...
void lv_demo_widgets(void)
{
    ...
    lv_theme_default_init(NULL, lv_palette_main(LV_PALETTE_CYAN), lv_palette_main(LV_PALETTE_DEEP_PURPLE), LV_THEME_DEFAULT_DARK, font_normal);

    /* lv_theme_mono_init(NULL, 1, font_normal); */
    ...
    lv_obj_t *t4 = lv_tabview_add_tab(tv, "OTA");
...
static void profile_create(lv_obj_t *parent)
{
    ...
    lv_obj_t *email_labe2 = lv_label_create(panel1);
    lv_label_set_text(email_labe2, "@smith.com");

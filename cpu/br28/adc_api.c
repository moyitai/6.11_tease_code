...
#define     VBAT_SAMPLE_FREQ    500 //ms

#define     VBAT_VALUE_ARRAY_SIZE  32// (32 + 1)

static u16 vbat_value_array[VBAT_VALUE_ARRAY_SIZE];
static u16 vbg_value_array[VBAT_VALUE_ARRAY_SIZE];
...
void _adc_init(u32 sys_lvd_en)
{
    ...
    adc_set_sample_freq(AD_CH_DTEMP, VBAT_SAMPLE_FREQ);
    ...
    printf_buf((u8 *)vbat_value_array, VBAT_VALUE_ARRAY_SIZE);

...
#if LV_TICK_CUSTOM
#define LV_TICK_CUSTOM_INCLUDE "asm/timer.h"//"Arduino.h"         /*Header for the system time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (timer_get_ms())//(millis())    /*Expression evaluating to current system time in ms*/

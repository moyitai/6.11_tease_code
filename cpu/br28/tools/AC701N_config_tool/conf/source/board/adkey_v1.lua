...
local adkey_en_hBox_view = checkbox_item_hbox_view(adkey_en);
...
-- ADKEY 外部上拉使能
local adkey_extern_up_en = cfg:i32("ADKEY 使用外部上拉:", 0);
...
local adkey_extern_up_en_hBox_view = checkbox_item_hbox_view(adkey_extern_up_en);
-----------------------------------------------------------     key res     ------------------------------------------------------
-- ADKEY 上拉阻值

...
__open_ok:
    ...
    dec->surround = surround_open_demo(dec->file_dec.output_ch_type);
#endif
...
void *file_eq_drc_open(u16 sample_rate, u8 ch_num)
{
    ...
    drc_en = 1;
#endif/*TCFG_DRC_ENABLE && TCFG_MUSIC_MODE_DRC_ENABLE*/
    ...
    return eq_drc;
#endif/*TCFG_EQ_ENABLE && TCFG_MUSIC_MODE_EQ_ENABLE*/
    return NULL;
}
